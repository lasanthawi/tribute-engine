...
export function demoGames(): { games: GameDto[] } {
  return {
    games: [
      ...
      {
        slug: 'stack-tower',
        template: 'stack_tower',
        title: 'Tower Stack',
        description: 'Drop blocks to build the tallest tower — line them up before it topples',
        icon: '🧱',
        config: {
          boardWidth: 280,
          blockWidth: 160,
          ...
          theme: {
            bg: '#0b0f1a',
            accent: '#6c5ce7',
            blockColors: ['#F7931A', '#6c5ce7', '#29B6F6', '#5be37a', '#ff5c5c', '#ffd166'],
          },
          rewardCurve: [
            { minScore: 0, points: 0 },
            { minScore: 3, points: 5 },
            { minScore: 6, points: 10 },
            { minScore: 10, points: 15 },
            { minScore: 15, points: 25 },
            { minScore: 20, points: 35 },
            { minScore: 25, points: 40 },
          ],
          maxScore: 25,
        },
        coverImageUrl: '/games/stack-cover.svg',
        remainingPlays: 3,
        maxPlaysPerDay: 3,
      },
      {
        ...
        description: 'Watch the multiplier climb and cash out before the rocket explodes',
        icon: '🚀',
        config: {
          growthRate: 70,
          crashStartScore: 150,
          baseCrashChance: 0.01,
          crashChanceRamp: 0.03,
          maxScore: 500,
          rewardCurve: [
            { minScore: 0, points: 0 },
            { minScore: 150, points: 10 },
            { minScore: 200, points: 20 },
            { minScore: 250, points: 35 },
            { minScore: 300, points: 50 },
            { minScore: 400, points: 80 },
            { minScore: 500, points: 150 },
          ],
          theme: { bg: '#0b0f1a', accent: '#29B6F6', danger: '#ff4d6a' },
        },
        coverImageUrl: null,
        remainingPlays: 3,
        maxPlaysPerDay: 3,
