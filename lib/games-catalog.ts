...
import { GameTemplate, GameStatus, TapCatchConfig, SpinWheelConfig, SnakeConfig, StackTowerConfig, CrashConfig } from './game-templates'
...
function toCatalogGame(row: {
  ...
  return {
    ...
    icon: row.icon,
    config: row.config as TapCatchConfig | SpinWheelConfig | SnakeConfig | StackTowerConfig | CrashConfig,
